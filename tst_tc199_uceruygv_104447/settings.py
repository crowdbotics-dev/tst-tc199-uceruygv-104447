"""
Django settings for tst_tc199_uceruygv_104447 project.
...
ROOT_URLCONF = 'tst_tc199_uceruygv_104447.urls'
...
WSGI_APPLICATION = 'tst_tc199_uceruygv_104447.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_tc199_uceruygv_104447 API",
    "DESCRIPTION": "API documentation for tst_tc199_uceruygv_104447 App",
    "VERSION": "v1",
}
